...
/**
 * Support for Jackson 3.0 (https://github.com/FasterXML/jackson-core)
 */
class Jackson3Mapper implements ObjectMapper {
    ...
    private tools.jackson.databind.ObjectMapper createJackson3ObjectMapper(Class cls, String charset) {
    ...
    String serialize(ObjectMapperSerializationContext context) {
        ...
        def mapper = createJackson3ObjectMapper(object.getClass(), context.getCharset())
